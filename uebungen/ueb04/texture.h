...
/**
 * Entbindet die Textur texture, so dass sie fuer alle nachfolgende gezeichneten
 * Primitiven nicht mehr verwendet wird.
 * @param texture Bezeichner der Textur, die entbunden werden soll.
 */
