...
initTextureArray(void)
{
  ...
  g_textures[tex0].filename = "textures/landscape_0.jpg";
  g_textures[tex1].filename = "textures/landscape_1.jpg";
  g_textures[tex2].filename = "textures/landscape_2.jpg";
  g_textures[tex3].filename = "textures/landscape_3.jpg";
...
void unbindTexture(TexName texture)
{
